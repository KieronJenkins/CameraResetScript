...
def maya_camera_clipping():
    cmds.viewClipPlane( "frontShape", ncp="0.1", fcp = "100000.0" ) # To change the clipping planes, change the numbers inbetween the " " to what you need
    cmds.viewClipPlane( "perspShape", ncp="0.1", fcp = "100000.0" ) # ncp = near clip plane // fcp = far clip plane
    cmds.viewClipPlane( "sideShape", ncp="0.1", fcp = "100000.0" )
    cmds.viewClipPlane( "topShape", ncp="0.1", fcp = "100000.0" )
